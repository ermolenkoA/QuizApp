...
object UtilsEn {
    const val langKeyEn = "en"
    const val databaseEN = "TopicDatabaseEn"
    val dataset = arrayListOf(
        Topic(
            id = 0,
            title = "Animals",
            image = getUrlString(R.drawable.animal_img),
            about = "In this quiz you need to answer questions about animals.",
            questions = arrayListOf(
                Question(
                    id = 0,
                    title = "Although they seem happy, which animal's laughter is a reaction to a threat?",
                    image = null,
                ...
                Question(
                    id = 1,
                    title = "What is the smallest vertebrate?",
                    image = null,
                    fakeAnswers = arrayListOf(
                        "Fish",
                        "Lizard",
                ...
                Question(
                    ...
                    realAnswer = "Albatross"
                ),
                Question(
                    id = 3,
                    title = "Which animal is the fastest on land?",
                    image = null,
                    fakeAnswers = arrayListOf(
                        "Lion",
                        "Giraffe",
                ...
                Question(
                    id = 4,
                    title = "Which animal is the largest on Earth?",
                    image = null,
                    fakeAnswers = arrayListOf(
                        "African elephant",
                        "Colossal squid",
